...
class SwerveModuleGainSet():
    ...
    def __init__(self):
        ...
        self.wheelA = Calibration("Drivetrain Module Wheel kA", 0.000,  "volts/radPerSecPerSec")
        self.wheelV = Calibration("Drivetrain Module Wheel kV", 0.0201, "volts/radPerSec")
